...
class TranscriptionService:
    ...
    Constructor accepts the same args as the old local Whisper
    for backward compatibility with existing deps.py.
    """
    ...
    def _init_local_whisper(self):
        ...
        try:
            ...
            logger.info(f"Loading local Whisper: {self._model_size} on {self._device}")
