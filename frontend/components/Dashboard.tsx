...
<body>
  ...
  function keepEnglishOnly(str: string) {
  ...
  const getNotesLatex = () => {
    ...
    const content = notesNotebook.cells
      ?.map((cell: any) => {
        ...
        // Keep only English / ASCII to avoid non-english characters in LaTeX
    ...
    // Remove emojis and non-English chars from title for LaTeX safety
